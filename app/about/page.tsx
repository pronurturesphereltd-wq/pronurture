...
const defaultValues = [
  ...
  { headline: 'PSL is a launchpad, not a listing site.', body: "We are building something that helps Nigerian healthcare professionals grow, not just move between jobs." },
]

const defaultSurveyStats = [
  '52.5% have taken a job that turned out different from its listing',
  "62.5% are behind on or do not know their CPD requirements",
  ...
  return (
    <>
      <section style={{ padding: '72px 0', background: 'var(--brand-offwhite)' }}>
        <AnimateOnScroll><div className="container" style={{ maxWidth: 780 }}>
      ...
      <section style={{ padding: 'var(--section-padding-y) 0' }}>
        <div className="container">
          ...
          {team.length > 0 ? (
            ...
            <AnimateOnScroll><div style={{ maxWidth: 620, margin: '0 auto', textAlign: 'center', padding: '40px 48px', borderRadius: 24, border: '1px solid rgba(0,0,0,0.08)', background: 'var(--brand-offwhite)' }}>
