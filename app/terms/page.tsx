...
export const metadata = {
  ...
  description:
    "The terms and conditions governing use of the ProNurtureSphere platform — what you agree to when visiting our website or joining the early access programme.",
};
